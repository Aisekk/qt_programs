#include "st.h"
//Раздел 14.4. Двойное хеширование. Глава 14. Хеширование.
//Метод хеширования с открытой адресацией (линейное опробование с двумя хеш-функциями)
int main()
{
    //---------------------------------------------------------------------------------------------
    //целочисленные ключи
    ...
    cout << "K\tV\tHash" << endl;
    for(int i = 0; i < N; i++)
    { int key = 2*i+1; Item v; v.init(key); /*v.init(rand() % 10);*/ hashT.insert(v); }
    //---------------------------------------------------------------------------------------------
