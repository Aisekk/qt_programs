...
#include "st.h"
using namespace std;
//Раздел 13.1. Глава 13. Сбалансированные деревья
...
int main()
{
    ...
    //---------------------------------------------------------------------------------------------
    cout << "Random binary search tree: " << endl;
    cout << "K,V" << endl;
    BST.show(); cout << BST.count() << " keys" << endl;
    //---------------------------------------------------------------------------------------------
    cout << "Random binary search tree balanced: " << endl;
    BST.balance(); cout << "K,V" << endl;
    BST.show(); cout << BST.count() << " keys" << endl;
    //---------------------------------------------------------------------------------------------
    Key key = 5; Item found = BST.search(key);
    cout << "Random binary search item with key = " << key << ": "; found.showValue();
    //---------------------------------------------------------------------------------------------
