...
#include "st.h"
using namespace std;
//Раздел 13.4. Глава 13. Сбалансированные деревья
//Красно-черное BST-дерево без дубликатов
...
int main()
{
    ...
    //---------------------------------------------------------------------------------------------
    cout << "Red-black binary search tree: " << endl;
    cout << "K,V" << endl;
    BST.show(); cout << BST.count() << " keys" << endl;
    BST.sumOfKeys();
    cout << "Top down show: " << endl;
    BST.showTopDown(); cout << BST.count() << " keys" << endl;
    //---------------------------------------------------------------------------------------------
