...
void SystemNorms::findTestElemNorm(NormsID normsID,
                                   const QString& fullTestName, ValuePrefix valuePrefix,
                                   double& criterionDn, double& criterionUp)
{
    ...
    if(upBase)
        upBase->setTestInterval(fullTestName, valuePrefix, criterionDn, criterionUp);
}
