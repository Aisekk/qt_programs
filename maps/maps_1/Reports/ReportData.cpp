...
//-------------------------------------------------------------------------------------------------
void ReportData::setReportFormat(const ReportFormat repFormat)
{
    m_reportFormat = repFormat;
}
void ReportData::setNormsID(const NormsID id)
{
    m_normsID = id;
}
void ReportData::setMapType(const MapType mapType)
{
    m_mapType = mapType;
}
