...
//--------------------------------------------------------------------------------------------
//чтение настроек
void readSettings_GlobalNorm(double &criteriumDn, double &criteriumUp,
...
public slots:
    ...
    //--------------------------------------------------------------------------------------------
private:
    shared_ptr<QSettings> m_spSettings{nullptr};
    shared_ptr<LocalSettingsWin> m_spLocalSettingsWin{nullptr};
    shared_ptr<GlobalSettingsWin> m_spGlobalSettingsWin{nullptr};
};
//==================================================================================================
