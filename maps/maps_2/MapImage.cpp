...
void MapImage::setNormsInterval(const double CriterionDn, const double CriterionUp)
{
...
void MapImage::setNormsDeviations(const double CriterionDn, const double CriterionUp)
{
