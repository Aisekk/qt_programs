...
ReportsWinTXT::ReportsWinTXT(QWidget *pwgt, const shared_ptr<Lot> spLot) :
...
//----------------------------------------------------------------------------------------
void ReportsWinTXT::setReportFormat(const ReportFormat repFormat)
{
    m_reportData.setReportFormat(repFormat);
}
void ReportsWinTXT::setNormsID(const NormsID id)
{
    m_reportData.setNormsID(id);
}
void ReportsWinTXT::setMapType(const MapType mapType)
{
