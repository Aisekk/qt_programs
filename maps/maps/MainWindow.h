...
//Parser
#include "FileReader/FileReader_4082.h"
#include "FileReader/FileReader_ResMap.h"
//Reports
...
public:
    ...
    ~MainWindow();
public slots:
    void slotStatisticsRecalc(int X, int Y, Mask maskState);
    //================================================================================================
protected:
...
private:
    ...
    void addLotTab(size_t lotNum, const QString &lotName);
    ...
    void setPrefixIntoTestElemDies(shared_ptr<TestElem> spTestElem, ValuePrefix prefix);
    //--------------------------------------------------------------------------------------------
    ...
    QAction *m_pactInitDynIntervals;
    //копировать динамические интервалы во все слоты
    QAction *m_pactCopyDynIntervals;
...
private slots:
    ...
    void slotTestElemDynIntervalWin();
    //расчет статистики
    ...
    void slotCalcTestElemByDynInterval(const QPair<double, double> &twoValues);
    //строка состояния - показать выбранную норму
    void slotShowGlobalNorms();
    void slotShowLocalNorms();
    void slotShowDynamicInterval();
    void slotShowZSH();
    void slotShowFAU();
    ...
    //инициализировать динамические интервалы значениями по умолчанию
    void slotInitDynIntervalsByDefault();
    //копировать динамические интервалы из первого слота в остальные слоты
    void slotCopyDynIntervalsAndPrefixes();
    //справка
    void slotHelpWin();
    //о программе
    void slotAbout();
